      ...
      <section class="section section-bredcrumbs"style="--bg-image: url(../images/estructuras.jpg);">
        <div class="container context-dark breadcrumb-wrapper" >
          ...
          <ul class="breadcrumbs-custom">
            ...
            <li class="active"><a href="baldes.php">Baldes</a></li>
          </ul>
        </div>
      </section>
      <!-- Overview-->
          ...
          <div class="row justify-content-center">
            <div class="col-sm-12 col-md-6 d-flex justify-content-around">
              ...
              <div class="">
                ...
                <ul>
                  <li>Diámetro Exterior desde 400mm hasta 2500mm</li>
                  <li>Kelly box 130mm / 150mm / 200mm.</li>
                  <li>Cierre mecánico o cierre automatico.</li>
                </ul>
              </div>
            </div>
            <div class="col-sm-12 col-xl-6  d-flex justify-content-around">
              ...
              <div>
                ...
                <ul>
                  <li>Diámetros de fabricación desde 600mm hasta 1500mm.</li>
