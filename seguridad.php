<?php 
  $page_title = "Astillero Naval y seguridad industrial- Colpiñones";
  $current_page = "areas";
?>
<!DOCTYPE html>
    ...
    <div class="page">
      ...
      <section class="section section-bredcrumbs"style="--bg-image: url(../images/estructuras.jpg);">
        <div class="container context-dark breadcrumb-wrapper" >
          <h1>Astillero Naval y seguridad industrial</h1>
          <ul class="breadcrumbs-custom">
            <li><a href="index.php">Inicio</a></li>
            <li><a href="sectores.php">Sectores industriales</a></li>
            <li class="active"><a href="seguridad.php">Astillero Naval y seguridad industrial</a></li>
          </ul>
        </div>
      </section>
      <!-- Overview-->
